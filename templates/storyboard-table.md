...
| 焦段 | [14/18/24/28/35/50/85/135/200mm] |
| 景深 | [Deep Focus / Normal / Shallow DOF / Rack Focus] |
| 光圈 | [f/1.4~f/16] |
...
| 光线方案 | [KEY:方向 FILL:方向 BACK:方向] |
| 轴线 | [AXIS: A↔B / SAME SIDE / CROSS ⚠️] |
| 视线 | [👀 LOOK→/←/↑/↓/OFF-SCREEN/DIRECT-TO-CAM] |
| FX/特效 | [无 / CGI / GS绿幕 / Particle / Compositing / Practical FX] |
| VFX层级 | [如涉及合成：L1前景/L2中景/L3背景/...] |
...
|-----------|------|
| 相机位置 | [(x, y, z) 大致位置] |
| 轴线侧 | [北侧/南侧/东侧/西侧 — 相对于180度轴线] |
| 是否越轴 | [NO / YES(过渡镜头N) / ⚠️YES(无过渡)] |
| 角色A位置+朝向 | [(x, y, z) 朝向:N/S/E/W/NE/NW/SE/SW] |
| 角色B位置+朝向 | [(x, y, z) 朝向:N/S/E/W/NE/NW/SE/SW]（如适用） |
| 角色A视线 | [→/←/↑/↓/OFF-SCREEN L/OFF-SCREEN R/DIRECT] |
| 角色B视线 | [→/←/↑/↓/OFF-SCREEN L/OFF-SCREEN R/DIRECT]（如适用） |
| 视线匹配 | [✅ A↔B / ❌ / N/A(单人)] |
| 动作起始状态 | [延续自镜头N-1的结束状态描述] |
| 动作结束状态 | [传递给镜头N+1的起始状态描述] |
| 场景时钟 | [t=_s]（从场景第一个镜头开始的累计时间） |
| 时间类型 | [CONTINUOUS / JUMP(+Ns) / SLOW-MO] |
| 光源一致性 | [✅ / ⚠️变化(原因:___)] |
| 情绪坐标 | [V:_ A:_ D:_ I:_] — 主导情绪:[名称]（来自Emotion System Agent） |
...
- CGI/VFX区域：[绿幕区域/CGI元素位置/合成边界]

**声音参考**：
- 对白 (DIAL)：[角色的对白 + 语气描述]
- 音效 (SFX)：[环境音/特殊音效 + 时间点]
- 环境 (AMB)：[背景环境音描述]
- 配乐 (MUS)：[情绪/风格 + 入点/渐强描述]
- 画外音 (VO/OS)：[如有]
